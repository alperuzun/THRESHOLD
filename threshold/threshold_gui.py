...
class Page2(QWidget):
    def __init__(self):
        ...
        label.setStyleSheet("font-size: px; color: white; font-weight: bold; margin-top: 8px;")
...
class Page4(QWidget):
    def __init__(self):
        ...
        font = QFont("Proxima Nova", 14)
        Page4.button1.setFont(font)
        Page4.button1.setStyleSheet("font-size: 14px; color: white; background-color: rgba(0, 0, 0, 0.4); font-weight: bold; padding: 14px; margin-right: 4px;")
        Page4.button1.setFixedHeight(160)
        Page4.button1.clicked.connect(self.open_pdf1) 

        Page4.imported1 = QLabel(" ")
        Page4.imported1.setFont(font)
        ...
        font = QFont("Proxima Nova", 14)
        Page4.button2.setFont(font)
        Page4.button2.setStyleSheet("font-size: 14px; color: white; background-color: rgba(0, 0, 0, 0.4); font-weight: bold; padding: 14px; margin-left: 4px;")
        Page4.button2.setFixedHeight(160)  
        Page4.button2.clicked.connect(self.open_pdf2) 

        Page4.imported2 = QLabel(" ")
        Page4.imported2.setFont(font)
        ...
        button = QPushButton('Run Paired T-Test', self)
        font = QFont("Proxima Nova", 14)
        button.setFont(font)
        button.setStyleSheet("font-size: 14px; color: #325BA9; background-color: white; font-weight: bold;")
        layout.addWidget(button)
    ...
    def run_test(self):
        try:
            ...
            if results == "Error":
                ...
                titles = ["Calculations","Sample Size (n)", "Degrees of Freedom", "Mean Difference (d)", "Sum of Squared Differences from Mean", "Variance", "Standard Deviation (of differences)", "T-Statistic", "P-value","Interpretation"]
                stat_file(file_path, titles, results[0], results[1])

                Page5.interpretation1.setText(f"{results[0][9]}")
                Page5.interpretation2.setText(f"{results[1][9]}")
                Page5.meandiff1.setText(f"Mean Difference: {round(float(results[0][3]),4)}")
                Page5.meandiff2.setText(f"Mean Difference: {round(float(results[1][3]),4)}")
                Page5.sd1.setText(f"SD of Differences: {round(float(results[0][6]),4)}")
                Page5.sd2.setText(f"SD of Differences: {round(float(results[1][6]),4)}")
                Page5.tstat1.setText(f"T-Statistic: {round(float(results[0][7]),4)}")
                Page5.tstat2.setText(f"T-Statistic: {round(float(results[1][7]),4)}")
                Page5.p1.setText(f"p-value: {round(float(results[0][8]),8)}")
                Page5.p2.setText(f"p-value: {round(float(results[1][8]),8)}")
...
class Page5(QWidget):
    def __init__(self):
        ...
        title = QLabel("Two-Tailed Paired T-Test Results")
        font = QFont("Proxima Nova", 18)
        title.setFont(font)
        ...
        Page5.interpretation1.setFont(font)
        ...
        Page5.interpretation2.setFont(font)
